...
public class AVLTreeImpl<T extends Comparable<T>> extends BSTImpl<T> implements
	...
	//Vai subir desde o parent do node ate a raiz, chamando o rebalance para os nodes no caminho. A remocao de um no pode afetar o balance de todos estes nodes
	// AUXILIARY 
