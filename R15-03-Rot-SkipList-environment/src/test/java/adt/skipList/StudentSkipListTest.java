...
public class StudentSkipListTest {
	...
	@Test
	public void testMetodoNovo(){
		Integer[] arrayKeys = {4, 12, 18,17,25,8, 14, 21};
		String[] arrayValues = {"4","12","18","17","25","8", "14", "21"};
		Integer[] arrayAlturas = {3,3,3,2,2,4,4,4};
		for(int i = 0; i < arrayValues.length; i++){
			this.skip.insert(arrayKeys[i], arrayValues[i], arrayAlturas[i]);
		}
		((SkipListImpl<String>) this.skip).imprimePorAlturaEmOrdemCrescente();
	}
}
