...
public class StudentMaxHeapTest {
	...
	@Test
	public void verificaArrayAlternado(){
		Integer[] array = {5,4,3,2,1};
		Integer[] expected = {5,1,4,2,3};
		this.heap.buildHeap(array);

		assertArrayEquals(heap.retornaArrayAlternado(), expected);
		Arrays.equals(expected, heap.retornaArrayAlternado());
